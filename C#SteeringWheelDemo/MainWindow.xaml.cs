...
namespace SteeringWheelDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void btConnectDisconnect_Click(object sender, RoutedEventArgs e)
        {
            ...
            if ((string)btConnectDisconnect.Content == sCONNECT)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    OutputList.Items.Add("Could not open the communication port!" + "\n" + "Error: " + ex.Message);
                }
            }
            else
            {
                ...
                {
                    // In case of error, show message to user
                    OutputList.Items.Add("Could not close the communication port!" + "\n" + "Error: " + ex.Message);
                }
        ...
        private void spUSB_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            {
                // In case of error, show message to user
                OutputList.Items.Add("Could not receive the data from the serial port of could not write data into file!" + "\n" + "Error: " + ex.Message);
            }
        }

        // Sbus packet genarator.
        ...
        private void dtSBUSTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                // In case of error, show message to user
                OutputList.Items.Add(ErrCount++ + ". " + "Could not write data out the communication port!" + "\n" + "Error: " + ex.Message);
            }
        }
